...
const services = [
  {
    ...
    description: "Data-driven marketing strategies tailored to your brand. We identify your audience, define goals, and build a roadmap that delivers measurable results.",
    tags: ["Brand positioning", "Market research", "Campaign planning", "Analytics"],
    accent: "Strategy",
    visual: "📐"
  },
  {
    ...
    description: "Performance-focused ad campaigns across Meta, Google, TikTok and beyond. Every forint spent is tracked, tested, and optimized for returns.",
  ...
  },
  {
    ...
    description: "High-quality creative production for all your digital needs — from scroll-stopping visuals to compelling video content that converts.",
    tags: ["Video", "Photography", "Motion graphics", "Reels"],
    accent: "Production",
    visual: "🎬"
  }
];
...
export default function Services() {
  ...
  return (
    <section id="services" style={{ background: '#0A0A0A', padding: '8rem 2rem' }}>
      <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
        ...
        <div style={{ marginBottom: '5rem', textAlign: 'center' }}>
          ...
          <h2 style={{
            ...
            fontWeight: 700, color: '#F5F5F5', letterSpacing: '-0.03em'
          }}>
            What we do
          </h2>
        </div>
            ...
            {services.map((s, i) => (
              ...
              >
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                  ...
                  <span style={{
                    fontSize: '1.2rem', opacity: active === i ? 1 : 0.2,
          ...
          <div style={{
            ...
            <div key={active} style={{ animation: 'fadeUp 0.35s ease forwards' }}>
              ...
              <h3 style={{
                ...
                fontWeight: 700, color: '#F5F5F5', marginBottom: '0.5rem',
