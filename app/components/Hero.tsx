export default function Hero() {
  return (
    <section className="relative flex flex-col items-center justify-center px-8 text-center overflow-hidden" style={{ minHeight: '70vh', paddingTop: '8rem' }}>
      ...
      {/* Badge */}
      <div className="animate-fade-up mb-6 inline-flex items-center gap-2 px-5 py-2" style={{
